...
//Create URL from the given string
    ...
    public static SingleMovie extractJSONforMovie(String json) {
       ...
       // double vote_movie = Double.parseDouble(null);
        double popularity = 0;
        ...
        try {
            ...
            r = current.getDouble("vote_average"); //TODO
            d = current.getString("release_date");
            popularity = current.getDouble("popularity");
            ...
            Log.d(" Pop ",String.valueOf(popularity));
            m = new SingleMovie(t, p, s, r, d, id_movie,popularity);
        }
